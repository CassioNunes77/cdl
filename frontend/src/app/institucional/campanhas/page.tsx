    ...
    <div className="py-12 sm:py-16 bg-gradient-to-b from-white to-cdl-gray/30">
      <div className="container-cdl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Campanhas e Eventos</h1>
        ...
        {loading ? (
          <p className="text-center text-cdl-gray-text">Carregando campanhas...</p>
        ) : (
          <>
